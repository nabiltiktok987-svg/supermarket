...
const scriptURL =
  "https://script.google.com/macros/s/AKfycbwsfg5ElOnj7eLfol5CF66jcPrlPUpc6LIezP2sNwroJzmNiYqh94KMRk3EcFcZ1uHNgg/exec";
function addToCart() {
...
function fetchOrdersFromSheet() {
  ...
  fetch(scriptURL)
    ...
    .catch((error) => {
      ...
      tableBody.innerHTML =
        "<tr><td colspan='4'>خطأ في تحميل البيانات</td></tr>";
    });
}
